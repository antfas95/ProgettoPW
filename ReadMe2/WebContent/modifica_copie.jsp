...
<body>
	...
	<h1>Modifica Copie</h1>
	
	<form action= "ModificaCopie" method="post">
		<Label>Codice</Label>
		<input type="text" name= "codice" class="form-control" placeholder="Codice" id="name" value="">
		<Label>Nuovo prezzo</Label>
		<input type="text" name= "copie" class="form-control" placeholder="Prezzo" id="name" value="">
		<center>
			<button name="registrazione" id="cambiamento" action= "Prova">Modifica</button>
